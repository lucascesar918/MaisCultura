<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="denuncia.aspx.cs" Inherits="MenosCultura.denuncia" %>
               ...
               <section class="denuncia">  
                ...
                <div class="divInfo">
                   ...
                   <div class="descricaoDenuncia">
                       ...
                       <asp:Literal ID="litTextoDenuncia" runat="server">Prometeram que os participantes do evento ganhariam uma camisa grátis e 50% de desconto nos casacos, porém, na hora das compras, todos os vendedores estavam passando nos cartões os valores completos, sem desconto, e ninguém estava notando!</asp:Literal>
                       </div>
                      </div>
                   <section class="btns">
