<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventoEspecificoCriador.aspx.cs"
    Inherits="MaisCultura.Site.EventoEspecificoCriador" %>
        ...
        <form id="form1" runat="server">
            ...
            <main class="principal">
                <div class="filtros">
                    ...
                    <asp:Button ID="btnCatPintura" runat="server" Text="Pintura"
                        class=" filtros-subtitulos categoria" />
                    <asp:Button ID="btnCatMusica" runat="server" Text="Música" class=" filtros-subtitulos categoria" />
                    <asp:Button ID="btnCatEsporte" runat="server" Text="Esporte"
                        class=" filtros-subtitulos categoria" />
                    <asp:Button ID="btnCatCinema" runat="server" Text="Cinema" class=" filtros-subtitulos categoria" />
                    <asp:Button ID="btnCatTeatro" runat="server" Text="Teatro" class=" filtros-subtitulos categoria" />
                    <asp:Button ID="btnCatJogos" runat="server" Text="Jogos" class=" filtros-subtitulos categoria" />
                    <asp:Button ID="btnCatRPG" runat="server" Text="RPG" class=" filtros-subtitulos categoria" />
                    <asp:Button ID="btnVerMais" runat="server" Text="Ver mais categorias"
                        class=" filtros-subtitulos verMais" />
                    <br />
                    <h2 class="filtros-titulos">Local</h2>
                    <asp:TextBox ID="txtLocal" runat="server" CssClass="txtLocal" placeholder="Insira aqui a cidade...">
                    </asp:TextBox>
                ...
                <div class="corpo">
                    <section class="inputPesquisa">
                        <section class="txtIcon">
                            <asp:TextBox ID="txtPesquisa" runat="server" CssClass="txt txtPesquisa"
                                placeHolder="O que você quer ver hoje?"></asp:TextBox>
                    ...
                    <div class="eventos">
                        <a href="EventoEspecificoCriador.aspx">
                            <section class="card">
